      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="text-2xl font-extrabold text-gray-800 tracking-tight">
          <a href="/" className="flex items-center space-x-1">
            <span>SiteKaro</span>
            <span className="text-[#FF4F0F]">.com</span>
          </a>
        </div>
        ...
        <div className="md:hidden">
          <a
            href="#proposal"
            className="bg-[#FF4F0F] hover:bg-red-400 text-white font-semibold py-2 px-4 rounded-full shadow-sm flex items-center gap-2 transition-all duration-200 text-sm"
          >
        ...
        <div className="hidden md:flex items-center space-x-8 text-gray-700 text-sm">
          <div className="flex items-center space-x-2">
            <FiPhone className="text-[#FF4F0F] text-lg" />
            <a href="tel:+919310851557" className="hover:text-[#FF4F0F] font-medium transition-colors">
              +91 93108 51557
            </a>
          </div>
          <div className="flex items-center space-x-2">
            <FiMail className="text-[#FF4F0F] text-lg" />
            <a href="mailto:info@sitekaro.com" className="hover:text-[#FF4F0F] font-medium transition-colors">
              info@sitekaro.com
            </a>
          </div>
          <a
